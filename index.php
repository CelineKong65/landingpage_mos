...
<head>
   ...
   /* Responsive Design */
    @media (min-width: 320px) and (max-width: 480px) {
        ...
        nav ul li button.nav-button,.link {
            font-size: 11px;
        }
        ...
        .product-card img {
            ...
            max-width: 700px; /* Maximum width on smaller screens */
            display: block;
            margin: 0 auto;
        }

        /* Adjust product grids images */
        .product-grids img {
            width: 100%; /* Scale the image to fit its container */
            height: auto; /* Maintain aspect ratio */
            max-width: 700px; /* Maximum width on smaller screens */
        ...
        .carousel-item img {
            max-height: 60%; /* Increase max-height for better image visibility */
            max-width: 100%; /* Increase max-width */
        }

        .carousel-indicators{
            transform: translateY(50px) translateX(-145px);
        }
        ...
        .tb-infor img {
            margin-right: 0; /* No margin needed if centering everything */
            max-width: 70px; /* Limits the width of the image */
            height: auto; 
        }
...
<body>
    <header>
        <h1>
            <img src="logo@2x.png" alt="faithview" class="logo">
        </h1>
        <nav>
            <ul>
    ...
    <section class="infor">
    <h2>For more information on MGROUP, <br>please contact us at:</h2>
